...
public class UserControllerTest {
	...
	@Test
	void testAddUserIsServiceMethodCalled() throws Exception {
	...
	@Test
	void testViewAllUsersIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		List<UserDTO> list = new ArrayList<UserDTO>();
		list.add(MasterData.getUserDto());
	...
	@Test
	void testUpdateUserIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		UserDTO userdto = MasterData.getUserDto();
	...
	void testDeleteUser() throws Exception{
		UserDTO userdto = MasterData.getUserDto();
		Mockito.when(userService.delete(userdto))
		.thenReturn(userdto);
		
		RequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/user/deleteUser")
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON);
	...
	@Test
	void testDeleteUserIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		UserDTO userdto = MasterData.getUserDto();
		Mockito.when(userService.delete(userdto)).then(new Answer<UserDTO>() {
