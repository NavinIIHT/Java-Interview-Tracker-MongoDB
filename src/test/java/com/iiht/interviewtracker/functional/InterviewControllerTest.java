...
public class InterviewControllerTest {
	...
	@Test
	void testAddInterviewIsServiceMethodCalled() throws Exception {
	...
	void testAddAttendee() throws Exception {
		InterviewDTO interviewdto = MasterData.getInterviewDto();
		Mockito.when(interviewService.addAttendee())
		.thenReturn(interviewdto);
	...
	@Test
	void testAddAttendeeIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		InterviewDTO interviewdto = MasterData.getInterviewDto();
		Mockito.when(interviewService.addAttendee()).then(new Answer<InterviewDTO>() {
	...
	@Test
	void testViewAllInterviewsIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		List<InterviewDTO> list = new ArrayList<InterviewDTO>();
		list.add(MasterData.getInterviewDto());
	...
	@Test
	void testUpdateInterviewsIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		InterviewDTO interviewdto = MasterData.getInterviewDto();
	...
	void testDeleteInterview() throws Exception{
		InterviewDTO interviewdto = MasterData.getInterviewDto();
		Mockito.when(interviewService.delete(interviewdto))
		.thenReturn(interviewdto);
		
		RequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/interview/deleteInterview")
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON);
	...
	@Test
	void testDeleteInterviewIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		InterviewDTO interviewdto = MasterData.getInterviewDto();
		Mockito.when(interviewService.delete(interviewdto)).then(new Answer<InterviewDTO>() {
	...
	@Test
	void testFindByInterviewNameIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		...
		interview2.setInterviewName("Java");
		List<InterviewDTO> list = new ArrayList();
		list.add(interview1);
		list.add(interview2);
		Mockito.when(interviewService.findInterviewByName("Java")).then(new Answer<List<InterviewDTO>>() {
	...
	void testShowInterview() throws Exception {
		...
		Mockito.when(interviewService.showInterview("1")).thenReturn(interviewDTO);
	...
	@Test
	void testShowInterviewIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		InterviewDTO interview1 = MasterData.getInterviewDto();
		InterviewDTO interview2 = MasterData.getInterviewDto();
		interview1.setInterviewId("1");
		interview2.setInterviewId("1");
		List<InterviewDTO> list = new ArrayList();
		list.add(interview1);
		list.add(interview2);
		Mockito.when(interviewService.showInterview("1")).then(new Answer<List<InterviewDTO>>() {
	...
	@Test
	void testFindByInterviewerNameIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
	...
	void testCountNoOfInterviews() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/interview/count")
	...
	@Test
	void testCountNoOfInterviewsIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		Integer i = interviewService.countInterviews();
